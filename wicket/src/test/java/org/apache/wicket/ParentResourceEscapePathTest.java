...
public class ParentResourceEscapePathTest extends WicketTestCase
{
  ...
  private void resourceUrlGeneratedByResourceReference()
  {
    final ResourceReference ref =
     new ResourceReference(ParentResourceEscapePathTestPage.class, "../../../ParentResourceTest.js");
  ...
  private void requestHandlingOfResourceUrlWithEscapeStringInside()
  {
    ...
    request.setURL("http://localhost/WicketTester$DummyWebApplication/WicketTester$DummyWebApplication/" + expectedResourceUrl());
  ...
  {
    final CharSequence escapeSequence = tester.getApplication().getResourceSettings().getParentFolderPlaceholder();
