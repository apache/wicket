...
/**
 * Implementation of a special link component that can handle linkClicked events
 * (implements {@link wicket.markup.html.link.ILinkListener}) but that can be
 * used with any kind of tag. At render time, an onclick event handler is added
 * to the tag (or the existing one is replaced) like:
 * 
 * <pre>
 * onclick = &quot;location.href='/myapp/...'&quot;
 * </pre>.
 * <p>
 * The OnClickLink can be placed on any tag that has a onclick handler (e.g.
 * buttons, tr/ td's etc).
 * </p>
 * <p>
 ...
 * </pre>
 * 
 * or (with a onclick handler that will be replaced but can be usefull when
 * designing):
 * 
 * <pre>
 * 
