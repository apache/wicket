			...
			IComponentResolverMarker
{
	...
	// FIXME: General: Any reason why this hasnt been folded into a flag?
	 ...
	 */
	public Border setRenderWrapped(boolean renderWrapped)
	{
		// FIXME: General: Implement this new feature
		return this;
	}
