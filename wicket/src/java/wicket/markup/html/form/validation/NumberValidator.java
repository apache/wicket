 ...
 * See the static factory methods to make range/minimum or maximum validators
 * for doubles or longs
 * 
...
public abstract class NumberValidator extends AbstractValidator
{
    ...
    /**
     * Gets a Integer range validator to check if a number is 
     * between the mininum and maximum value.
     * 
     * If that is not the case then an error message will be generated
     * with the key "NumberValidator.range" and the messages keys that 
     * can be used are:
     * <ul>
     ...
     * 
     * If that is not the case then an error message will be generated
     * with the key "NumberValidator.minimum" and the messages keys that 
     * can be used are:
     * <ul>
     * <li>${minimum}: the minimal value</li>
	 * <li>${input}: the input the user did give</li>
    ...
    /**
     * Gets a Integer range validator to check if an integer value is 
    ...
    /**
     * Gets a Double range validator to check if a number is 
     * between the mininum and maximum value.
     * 
     * If that is not the case then an error message will be generated
     * with the key "NumberValidator.range" and the messages keys that 
    ...
    /**
     * Gets a Double minimum validator to check if a integer value is 
     * greater then the given minimum value.
     * 
     * If that is not the case then an error message will be generated
     * with the key "NumberValidator.minimum" and the messages keys that 
    ...
    /**
     * Gets a Double range validator to check if an integer value is 
     * smaller then the given maximum value.
     * 
     * If that is not the case then an error message will be generated
     * with the key "StringValidator.maximum" and the messages keys that 
    ...
    private static class RangeValidator extends NumberValidator
    {
		...
		/**
		 * @see wicket.markup.html.form.validation.NumberValidator#onValidate(wicket.markup.html.form.FormComponent, Number)
		 */
