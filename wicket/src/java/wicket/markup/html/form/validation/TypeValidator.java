 ...
 * {@link wicket.util.convert.ConverterRegistry}instance of that can be found
...
public class TypeValidator extends AbstractValidator
{
    ...
    /**
     * Construct. If useLocalized is true, the current session's locale will be
     * used for conversion. If useLocalized is false, no localization will be
     * used for checking.
     * 
     * @param type
     *            the type to use for checking
     * @param useLocalized
     *            whether localization (using the current session's locale)
     *            should be used
     */
