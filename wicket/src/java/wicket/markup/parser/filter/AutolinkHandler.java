 ...
 * attribute and which are not Wicket specific components and flags these
 * tags (ComponentTag) as autolink enabled. A component resolver will later
 * only resolve the href and assign a BookmarkablePageLink to it (automatically).
 * <p>
...
public class AutolinkHandler implements IMarkupFilter
{
    ...
    /**
     * Construct.
     * @param nextInChain The next element in the chain. 
     */
     ...
     * @param enable if true, autolinks are enabled
     */
    ...
    /**
     * Get the next MarkupElement from the parent MarkupFilter and handles it
