/*
 * $Id: AutolinkComponentResolver.java,v 1.7 2005/01/18 08:04:29 jonathanlocke
 * Exp $ $Revision$ $Date$
 * 
 * ==================================================================== Licensed
...
/**
 * The AutolinkComponentNameResolver is responsible to deal with [autolink]
 * components which are used in hrefs like &lt;a wicket="[autolink]
 * href="Home.html"&gt;Home&lt;/a&gt;
 * 
 * It automatically creates a BookmarkablePageLink component using the tag
 * syntax: "[autolink:parameters]", where parameters can be a list of comma
 * separated key value pairs, such as "x=9,y=foo".
 * 
 * It resolves the given URL by searching for a page class at the relative URL
 * specified by the href attribute of the tag. The href URL is relative to the
 * package containing the page where this component is contained.
 * 
...
{ // TODO finalize javadoc
    ...
    /**
     * Resolves the given tag's automaticLinkPageClass and
     * automaticLinkPageParameters variables by parsing the tag component name
     * and then searching for a page class at the relative URL specified by the
     * href attribute of the tag. The href URL is relative to the package
     * containing the page where this component is contained.
     * 
     * @param page
     *            The page where the link is
     * @param markupStream
     *            Markup stream to use when throwing any exceptions
     * @param componentName
            ...
            final ComponentTag tag)
    {
        ...
        if (matcher.matches())
        {
            ...
            else
            {
                ...
                {
                    markupStream
                            .throwMarkupException("Special component names include [border], [body] and [autolink], "
                                    + "but not '" + command + "'");
                }
            }
        }
