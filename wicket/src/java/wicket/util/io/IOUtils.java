 ...
 * efficient in tests.
 * <p>
 * Wherever possible, the methods in this class do <em>not</em> flush or close the
 * stream. This is to avoid making non-portable assumptions about the streams' origin and
 * further use. Thus the caller is still responsible for closing streams after use.
 * <p>
...
public class IOUtils
{
	 ...
	 * <p>
	 * Equivalent to {@link Reader#close()}, except any exceptions will be ignored. This
	 ...
	 * <p>
	 * Equivalent to {@link Writer#close()}, except any exceptions will be ignored. This
	 * is typically used in finally blocks.
	...
	// -----------------------------------------------------------------------
	/**
	 * Get the contents of an <code>InputStream</code> as a character array using the
	 * default character encoding of the platform.
	 * <p>
	 * This method buffers the input internally, so there is no need to use a
	 * <code>BufferedInputStream</code>.
	...
	/**
	 * Get the contents of an <code>InputStream</code> as a String using the specified
	 * character encoding.
	 * <p>
	 * Character encoding names can be found at <a
	 * href="http://www.iana.org/assignments/character-sets">IANA</a>.
	...
	/**
	 * Writes bytes from a <code>byte[]</code> to chars on a <code>Writer</code> using
	 ...
	 * @return true if the content of the streams are equal or they both don't exist,
	 *         false otherwise
	 ...
	 * @return true if the content of the readers are equal or they both don't exist,
	 *         false otherwise
	 * @throws NullPointerException if either input is null
	 * @throws IOException if an I/O error occurs
	 * @since 1.1
