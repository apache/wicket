...
/**
 * Converts to and from Long objects using the current locale and optionally
 * a pattern for it conversion.
 *
 * @author Eelco Hillenius
 */
public final class LongLocaleConverter extends DecimalLocaleConverter
{
	/**
	 * Construct.
	 */
	 ...
	 */
	public LongLocaleConverter(String pattern)
	{
		this(pattern, false);
	}
	 ...
	 */
	public LongLocaleConverter(String pattern, boolean locPattern)
	{
