...
public class HybridUrlCodingStrategy extends AbstractRequestTargetUrlCodingStrategy
{
	 ...
	 */
	private Integer getOriginalOriginalTrailingSlashesCount(final IRequestHandler requestTarget)
	{
	 ...
	 */
	private PageParameters getPageParameters(final IRequestHandler requestTarget)
	{
	 ...
	 * @return page info
	 */
	private PageInfo getPageInfo(final IRequestHandler requestTarget)
	{
		if (requestTarget instanceof BookmarkablePageRequestTarget)
		{
			BookmarkablePageRequestTarget target = (BookmarkablePageRequestTarget)requestTarget;
