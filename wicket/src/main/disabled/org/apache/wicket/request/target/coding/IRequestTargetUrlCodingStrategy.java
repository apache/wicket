...
public interface IRequestTargetUrlCodingStrategy
{
	 ...
	 */
	CharSequence encode(IRequestHandler requestTarget);
	 ...
	 */
	IRequestHandler decode(ObsoleteRequestParameters requestParameters);
	 ...
	 */
	boolean matches(IRequestHandler requestTarget);
