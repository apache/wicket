...
public class HttpsRequestCycleProcessor extends WebRequestCycleProcessor
{
	 ...
	 */
	private Class<?> getPageClass(IRequestHandler target)
	{
	...
	protected IRequestHandler checkSecure(IRequestHandler target)
	{
		if (portConfig == null)
		{
			return target;
	...
	/** {@inheritDoc} */
	@Override
	public IRequestHandler resolve(RequestCycle rc, ObsoleteRequestParameters rp)
	{
