 ...
 * and generating a response), and it holds the intended {@link IRequestHandler request target},
 ...
 */
public abstract class _RequestCycle
{
	...
	/** Responding using the currently set {@link IRequestHandler}. */
	...
	/** holds the stack of set {@link IRequestHandler}, the last set op top. */
	private transient final ArrayListStack<IRequestHandler> requestTargets = new ArrayListStack<IRequestHandler>(
		3)
	{
		private static final long serialVersionUID = 1L;

		@Override
		public void add(int arg0, IRequestHandler arg1)
		{
		...
		@Override
		public boolean add(IRequestHandler arg0)
		{
		...
		{
			Iterator<? extends IRequestHandler> it = c.iterator();
			while (it.hasNext())
			{
	 ...
	 *            The response
	 */
	protected _RequestCycle(final Application application, final Request request,
	 ...
	 */
	public final IRequestHandler getRequestTarget()
	{
		return (!requestTargets.isEmpty()) ? (IRequestHandler)requestTargets.peek() : null;
	}
	 ...
	 *            request target
	 */
	public final void request(IRequestHandler target)
	{
		checkReuse();
	 ...
	 */
	public final void setRequestTarget(IRequestHandler requestTarget)
	{
	 ...
	 */
	private final CharSequence encodeUrlFor(final IRequestHandler requestTarget)
	{
	 ...
	 * @return a URL that references the given request target
	 */
	public final CharSequence urlFor(final IRequestHandler requestTarget)
	{
	 ...
	 * @param requestTarget
	 */
	protected void onRequestTargetSet(IRequestHandler requestTarget)
	{
	}
