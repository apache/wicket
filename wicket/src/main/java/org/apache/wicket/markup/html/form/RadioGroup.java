			...
			if (choice == null)
			{
				throw new WicketRuntimeException(
					"submitted http post value [" +
						...
						getPath() +
						"] is illegal because it does not point to a Radio component. Due to this the RadioGroup component cannot resolve the selected Radio component pointed to by the illegal value. A possible reason is that component hierarchy changed between rendering and form submission.");
			}
