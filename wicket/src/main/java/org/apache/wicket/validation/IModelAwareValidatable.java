...
/**
 * Validatable extension that allows access to component's model. This extension is implemented by
 * default but exists as a separate interface for backwards compatibility.
 * 
 * NOTE: in Wicket 1.5 {@link #getModel()} is implemented directly in {@link IValidatable}
 * 
 * @author igor
 * @param <T>
 */
