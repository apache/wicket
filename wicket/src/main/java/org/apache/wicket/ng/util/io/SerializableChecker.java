 ...
 */
package org.apache.wicket.ng.util.io;
...
public final class SerializableChecker extends ObjectOutputStream
{
	...
	private final String toPrettyPrintedStack(String type)
	{
		...
		for (Iterator<TraceSlot> i = traceStack.listIterator(); i.hasNext();)
		{
			...
			if (slot.object instanceof RequestableComponent)
			{
				RequestableComponent component = (RequestableComponent)slot.object;
	...
	protected final void writeObjectOverride(Object obj) throws IOException
	{
		...
		{
			fieldDescription = (root instanceof RequestableComponent) ? ((RequestableComponent)root).getPath() : "";
		}
