 ...
 */
package org.apache.wicket.ng.util.string;
...
public abstract class AbstractStringList implements IStringSequence, Serializable
{
	 ...
	 * @see org.apache.wicket.ng.util.string.IStringSequence#iterator()
	 */
	public abstract IStringIterator iterator();

	/**
	 * @return Number of strings in this string list
	 * @see org.apache.wicket.ng.util.string.IStringSequence#size()
	 */
	 ...
	 * @see org.apache.wicket.ng.util.string.IStringSequence#get(int)
	 */
