...
public interface IObjectStreamFactory
{
	...
	public static final class DefaultObjectStreamFactory implements IObjectStreamFactory
	{
		...
		/**
		 * @see org.apache.wicket.ng.util.io.IObjectStreamFactory#newObjectInputStream(java.io.InputStream)
		 */
		...
		/**
		 * @see org.apache.wicket.ng.util.io.IObjectStreamFactory#newObjectOutputStream(java.io.OutputStream)
		 */
