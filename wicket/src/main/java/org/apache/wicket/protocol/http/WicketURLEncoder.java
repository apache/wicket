...
/**
 * Adapted from java.net.URLEncoder, but defines instances for query string encoding
 * versus URL path component encoding.
 * <p/>
 * The difference is important because a space is encoded as a + in a query string, but
 * this is a valid value in a path component (and is therefore not decode back to a space).
 *
 * @author Doug Donohoe
...
public class WicketURLEncoder
{
    ...
    protected WicketURLEncoder(Type type)
    {
         ...
         * as is Netscape.
         *
         * This bit added by Doug Donohoe
         * ==================================
         * RFC 3986 (2005) updates this (http://tools.ietf.org/html/rfc3986):
         *
         ...
         * // -- PATH COMPONENT -- //
         *
         * path          = (see RFC for all variations)
        ...
        dontNeedEncoding.set('~'); // tilde encoded by java.net.URLEncoder version, but RFC is clear on this
