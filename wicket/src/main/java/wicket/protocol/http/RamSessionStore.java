 ...
 */
public class RamSessionStore extends AbstractHttpSessionStore
{
	/** Log. */
	private static final Log log = LogFactory.getLog(RamSessionStore.class);
