...
public class DeferredFileOutputStream extends ThresholdingOutputStream
{
	 ...
	 * 
	 * @return The data for this output stream, or <code>null</code> if no
	 ...
	 * assuming that the data was written to disk. If the data was retained in
	 * memory, this method returns <code>null</code>.
	 * 
	 * @return The file for this output stream, or <code>null</code> if no
	 *         such file exists.
	 */
	public File getFile()
	{
