...
public class DateTextField extends TextField implements ITextFormatProvider {
	 ...
	 */
	public static DateTextField forDatePattern(MarkupContainer parent,
			String id, IModel model, String datePattern) {
		return new DateTextField(parent, id, model, new PatternDateConverter(
				datePattern, true));
	}
	 ...
	 */
	public static DateTextField forDatePattern(MarkupContainer parent,
			String id, String datePattern) {
		return forDatePattern(parent, id, null, datePattern);
	}
	 ...
	 * @see wicket.markup.html.form.TextField
	 */
	public static DateTextField forDateStyle(MarkupContainer parent, String id,
			IModel model, String dateStyle) {
		return new DateTextField(parent, id, model, new StyleDateConverter(
				dateStyle, true));
	}
	...
	public static DateTextField forDateStyle(MarkupContainer parent, String id,
			String dateStyle) {
		return forDateStyle(parent, id, null, dateStyle);
	}
	 ...
	 * @see wicket.markup.html.form.TextField
	 */
	public static DateTextField forShortStyle(MarkupContainer parent, String id) {
		return forShortStyle(parent, id, null);
	}
	 ...
	 * @see wicket.markup.html.form.TextField
	 */
	public static DateTextField forShortStyle(MarkupContainer parent,
			String id, IModel model) {
		return new DateTextField(parent, id, model,
	 ...
	 * @see wicket.markup.html.form.TextField
	 */
	public static DateTextField withConverter(MarkupContainer parent,
			String id, DateConverter converter) {
		return withConverter(parent, id, null, converter);
	}
	 ...
	 */
	public static DateTextField withConverter(MarkupContainer parent,
			String id, IModel model, DateConverter converter) {
		return new DateTextField(parent, id, model, converter);
	}
	 ...
	 */
	public DateTextField(MarkupContainer parent, String id, IModel model,
			DateConverter converter) {
		super(parent, id, model, Date.class);
		if (converter == null) {
