 ...
 * If you are concerned about server state size, have larget trees with read-only cells,
 * implementing this interface and using it instead of e.g. Label can decrease the
 * memory footprint of tree table. 
 * 
 * @author Matej Knopp
 */
