...
public class WicketURLEncoder
{
	 ...
	 */
	public static final WicketURLEncoder QUERY_INSTANCE = new WicketURLEncoder(QUERY);
	 ...
	 */
	public static final WicketURLEncoder PATH_INSTANCE = new WicketURLEncoder(PATH);
