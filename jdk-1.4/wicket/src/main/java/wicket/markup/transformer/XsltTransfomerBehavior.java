...
/**
 * @deprecated has been renamed to {@link XsltTransformerBehavior}
 */
public class XsltTransfomerBehavior extends AbstractTransformerBehavior
{
	...
	{
		throw new WicketRuntimeException(XsltTransfomerBehavior.class.getName() + " has been renamed to " + XsltTransformerBehavior.class.getName());
	}
