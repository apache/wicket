...
NOTE: Providing a full description of Java support for i18n is clearly out of the scope of this document. If you need more information about this topic you can find it in the JavaDocs and in the official  https://docs.oracle.com/javase/tutorial/i18n/index.html[i18n tutorial] .
