...
Wicket provides wrapper classes that allow us to easily access web entities without the burden of using the low-level APIs of Java Servlet Specification. However it will always be possible to access standard classes (like _HttpSession_, _HttpServletRequest_, etc...) that lay under our Wicket application.
