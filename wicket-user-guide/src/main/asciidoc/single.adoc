...
:wicket_tutorial_examples_url: https://github.com/bitstorm/Wicket-tutorial-examples
...
=== Choosing between the JQuery and the plain JavaScript AJAX implementation

include::ajax/ajax_11.adoc[leveloffset=+1]
...
include::security/security_10.adoc[leveloffset=+1]
...
=== Markup parsing and auto components
