...
Wicket has made it quite easy to force existing AJAX components to be stateless. All we have to do is to override component's method _getStatelessHint_ returning true:
