...
To move and resize the overlay area we will use another module from  ueryUI[] ibrary ttp://jqueryui.com/position/[] hat allows us to position DOM elements on our page relative to another element.
