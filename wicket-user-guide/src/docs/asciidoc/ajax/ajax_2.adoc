...
image::edit-label-example-screenshot.png[]
...
image::autocomplete-example-screenshot.png[]
...
Class 'org.apache.wicket.extensions.ajax.markup.html.modal.ModalWindow' is an implementation of a  dal[http://www.wicket-library.com/wicket-examples-6.0.x/ajax/autocomplete] 
image::modal-window-example-screenshot.png[]
