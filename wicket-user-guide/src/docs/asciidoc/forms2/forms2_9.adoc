...
The Kelvin scale is wildly adopted among the scientific community and it is one of the seven base units of the  ternational[guide:layout_2] ":http://en.wikipedia.org/wiki/International_System_of_Units , so it makes perfect sense to store temperatures expressed with this unit of measurement.
