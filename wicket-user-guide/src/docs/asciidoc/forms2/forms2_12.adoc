...
image::list-multiple-choices.png[]
...
image::list-multiple-choices2.png[]

This component must be bound to a <select> tag but the attribute multiple= [":
multiple] ot required as it will automatically be added by the component. 
...
image::multi-select-transfer-component.png[]
...
image::multi-select-transfer-component-wicket.png[]
