...
NOTE: For more details about page storing you can take a look at paragraph  ge[] toring [] rom chapter  cket[] nternals [] he content of this paragraph is from wiki page https://cwiki.apache.org/confluence/display/WICKET/Page+Storage. 
