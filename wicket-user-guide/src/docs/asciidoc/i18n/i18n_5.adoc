...
Model _org.apache.wicket.model.ResourceModel_ acts just like the read-only model we have implemented in <<i18n.adoc#bundles-lookup-algorithm,paragraph 15.3>>. It simply retrieves a string resource corresponding to a given key:
