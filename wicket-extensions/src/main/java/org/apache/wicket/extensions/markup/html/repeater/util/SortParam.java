 ...
 * @deprecated Use {@link org.apache.wicket.markup.repeater.data.SortParam} instead
 */
@Deprecated
public class SortParam<T> extends org.apache.wicket.markup.repeater.data.SortParam<T>
{
	/**
