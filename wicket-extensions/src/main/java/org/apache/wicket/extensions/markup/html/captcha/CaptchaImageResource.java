...
public final class CaptchaImageResource extends DynamicImageResource
{
	...
	private static final RandomNumberGeneratorFactory factory = new RandomNumberGeneratorFactory();
	...
	{
		this(randomString(factory.newRandomNumberGenerator(), 10, 14));
	}
	...
	{
		return factory.newRandomNumberGenerator();
	}
