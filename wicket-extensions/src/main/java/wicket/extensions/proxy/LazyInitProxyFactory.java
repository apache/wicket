/*
 * $Id: LazyInitProxyFactory.java 5793 2006-05-20 11:10:12 +0000 (Sat, 20 May 2006) joco01 $
 * $Revision: 5793 $
...
public class LazyInitProxyFactory
{
			...
			Serializable, IWriteReplace
	{
		...
		/**
		 * @see wicket.extensions.proxy.ILazyInitProxy#getObjectLocator()
		 */
		...
		/**
		 * @see wicket.extensions.proxy.LazyInitProxyFactory.IWriteReplace#writeReplace()
		 */
