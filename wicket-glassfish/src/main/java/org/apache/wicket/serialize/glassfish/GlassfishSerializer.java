...
/**
 * Allows for Glassfish Proxy objects to be serialized and de-serialized when
 * using CDI Works with GF 3.1 GF 3.1.2 GF 4.0 Must include
 * glassfish-embedded-all for compile only it is provided in app server so don't
 * add to the war
 *
 * @author jsarman
 */
public class GlassfishSerializer implements ISerializer {
    ...
    public static class GlassfishStreamHandler implements JavaEEObjectStreamHandler {
        ...
        public Object replaceObject(Object obj)
            ...
            try {
                if (indirectlySerializableClass.isAssignableFrom(obj.getClass())) {
                    result = indirectlySerializableClass.getMethod("getSerializableObjectFactory", new Class[]{}).invoke(obj, new Object[]{}); //(IndirectlySerializable) obj).getSerializableObjectFactory();
                }
        ...
        public Object resolveObject(Object obj)
            ...
            Object result = obj;
            try {
                if (serializableObjectFactoryClass.isAssignableFrom(obj.getClass())) {// instanceof SerializableObjectFactory) {
                    result = serializableObjectFactoryClass.getMethod("createObject", new Class[]{}).invoke(obj, new Object[]{});//SerializableObjectFactory) obj).createObject();
                }
            } catch (NoSuchMethodException | SecurityException | IllegalAccessException | IllegalArgumentException | InvocationTargetException e) {
