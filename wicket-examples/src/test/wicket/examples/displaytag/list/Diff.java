/*
 * $Log$
 * Revision 1.2  2006/01/19 20:34:17  jdonnerstag
 * common base class for the tests
 * Revision 1.1 2005/03/25 16:28:47 eelco12 moved packages
 * from examples/contrib to wicket-stuff project
 * 
 * Revision 1.2 2005/02/28 22:06:07 eelco12 System.err.println & printStackTrace ->
 * log.error
 * 
 * Revision 1.1 2005/02/28 21:38:56 eelco12 issue 1145270 moved classes around a
 * bit to make clear that they are used for certain tests only.
 * 
 * Revision 1.1 2005/02/21 08:58:30 dashorst Preparing for release 0.9.18-beta
 * 
 ...
 * 
 * Revision 1.1 2004/11/29 22:10:27 jdonnerstag replaced Table with ListView
 * 
...
class Diff
{
	 ...
	 * bounds. All line numbers are origin-0 and discarded lines are not
	 * counted.
	 * 
	 * @param xoff
	 * @param xlim
	...
	{
		/**
		 * @see wicket.examples.displaytag.list.Diff.ScriptBuilder#build_script(boolean[],
		 *      int, boolean[], int)
		 */
	 ...
	 * are inserted. LINE0 and LINE1 are the first affected lines in the two
	 * files (origin 0). DELETED is the number of lines deleted here from file
	 * 0. INSERTED is the number of lines inserted here in file 1. If DELETED is
	 * 0 then LINE0 is the number of the line before which the insertion was
	...
	public static class change
	{
		 ...
		 * the number of lines inserted here in file 1. If DELETED is 0 then
		 * LINE0 is the number of the line before which the insertion was done;
