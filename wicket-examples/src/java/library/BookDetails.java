...
public final class BookDetails extends AuthenticatedHtmlPage
{
     ...
     */
    public static ExternalPageLink link(final String name, final Book book, final String noBookTitle)
    {
        final ExternalPageLink link = new ExternalPageLink(name, BookDetails.class);
        if (book != null)
        {
