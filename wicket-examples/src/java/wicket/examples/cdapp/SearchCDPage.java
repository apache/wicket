...
public class SearchCDPage extends WicketExamplePage
{
	...
	private class SearchCDResultsListView extends PageableListView
	{
		...
		public void populateItem(final ListItem item)
		{
			...
			params.put("id", id);
			item.add(new BookmarkablePageLink("title", EditCDPage.class, params).add(new Label(
					"title", cd.getTitle())));
			item.add(new BookmarkablePageLink("performers", EditCDPage.class, params).add(new Label(
					"performers", cd.getPerformers())));
			item.add(new BookmarkablePageLink("label", EditCDPage.class, params).add(new Label(
					"label", cd.getLabel())));
			item.add(new BookmarkablePageLink("year", EditCDPage.class, params).add(new Label("year",
