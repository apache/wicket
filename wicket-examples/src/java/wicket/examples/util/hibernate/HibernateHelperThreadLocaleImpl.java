...
public class HibernateHelperThreadLocaleImpl implements HibernateHelperDelegate
{
    ...
    /**
     * @see wicket.examples.util.hibernate.HibernateHelperDelegate#getSessionFactory()
     */
    ...
    /**
     * @see wicket.examples.util.hibernate.HibernateHelperDelegate#setSessionFactory(net.sf.hibernate.SessionFactory)
     */
    ...
    /**
     * @see wicket.examples.util.hibernate.HibernateHelperDelegate#getConfigURL()
     */
    ...
    /**
     * @see wicket.examples.util.hibernate.HibernateHelperDelegate#setConfigURL(java.net.URL)
     */
    ...
    /**
     * @see wicket.examples.util.hibernate.HibernateHelperDelegate#getConfiguration()
     */
