/*
 * $Id: TableWithAlternatingRowStyle.java 3764 2006-01-14 17:38:33Z jonathanlocke $
 * $Revision$
 * $Date: 2006-01-14 18:38:33 +0100 (Sa, 14 Jan 2006) $
 *
 * ====================================================================
...
/**
 * This is a simple pageable ListView extension automatically creating Labels for
 * each ListItem. In case Label is not the right one, you can still
 * add any other component you want. Alternating row styles are
 * provided as well.
 * 
...
public class SimplePageableListView extends PageableListView implements IComponentResolver
{
     ...
     * 
     * @param id The wicket:id of the tag
