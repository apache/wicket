...
/**
 * Page with examples on {@link wicket.extensions.markup.html.form.select.Select}.
...
public class SelectPage extends WicketExamplePage
{
	...
	public SelectPage()
	{
		...
		choices.add(new SelectOptions("manychoices", new Model((Serializable)MANY_CHOICES), renderer) );
