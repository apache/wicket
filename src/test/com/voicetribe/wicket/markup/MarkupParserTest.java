...
public final class MarkupParserTest extends TestCase
{
    public final void testTagParsing() throws StringValueConversionException, ParseException
    {
        ...
        final Markup markup = parser.parse("This is a test <a componentName=\"a\" href=\"foo.html\"> <b componentName=\"b\">Bold!</b> " +
    ...
    {
        final MarkupParser parser = new MarkupParser("componentName");
        final Markup tokens = parser.parse("This is a test <a componentName=9> <b>bold</b> <b componentName=10/></a> of the emergency broadcasting system");
