...
public class Tag implements DocumentElement {
    ...
    /**
     * Add an expected child to this tag. Children must be added
    ...
    /**
     * Add an expected attribute to this tag. The second parameter
     * is a regexp pattern on which to match the value of the tag.
     *
