 ...
 * HTTP protocol. Each HttpApplication has a name that comes from the name of
 * the concrete subclass which is instantiated. It also holds application
 * settings which are typically initialized in the subclass constructor. When
 * GET/POST requests are made via HTTP, a RequestCycle object is created from
 * the request, response and session objects. The RequestCycle's render() method
 * is called to produce a response to the HTTP request.
 * </p>
 * <p>
 ...
 */
public abstract class HttpApplication extends HttpServlet
        implements
            IApplication
{
    /** Log. */
    ...
    /**
     * Construct using configuraton information in XML of same name and location
     * as class.
     */
