...
public interface IXmlPullParser extends IMarkupFilter
{
     ...
     * The encoding is determined by analysing the 
     ...
     * @param stripComments if true, comments will be stripped
     */
    public abstract void setStripComments(boolean stripComments);

    /**
     * Set whether whitespace should be compressed.
     * @param compressWhitespace if true, whitespaces will be compressed
     */
    ...
    /**
     * Reads and parses markup from a resource like file. Use nextTag() to access 
     ...
     * which is not further analysed by Wicket. getInputSubsequence() is used
     * to access the raw markup.
     * 
    ...
    /**
     * Wicket dissects the markup into Wicket relevant tags and raw markup,
     * which is not further analysed by Wicket. getInputFromPositionMarker() 
