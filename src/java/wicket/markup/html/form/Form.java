...
public class Form<V> extends WebMarkupContainer<V> implements IFormSubmitListener
{
	 ...
	 * of the hiddenfield that is generated by this Form.
	 * The only 2 fields that are supported now are 'fs' (fake submits) and 'ws' (wicket state)
	 * 
	 * @param hiddenFieldName The name of the hiddenfield
	 * 
	...
	{
		return new AppendingStringBuffer("document.getElementById('").append(getHiddenFieldId(HIDDEN_FIELD_FAKE_SUBMIT))
	...
	/**
	 * @return the boolean if a form tries to generate a bookmarkable (stateless) link to itself.
	 */
