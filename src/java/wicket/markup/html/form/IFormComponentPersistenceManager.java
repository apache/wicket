/*
 * $Id: IFormComponentPersistenceManager.java,v 1.3 2005/01/09 16:35:11
 ...
 * data. <p/>
 * 
 * Given the interface different means of maintaining the data may be
 * implemented. A default implementation has been provided using Cookies.
 * 
 * @see <a href="http://java.sun.com/products/servlet/2.2/javadoc/javax/servlet/http/Cookie.html">for
 *      more details about Cookies. </a>
 * 
...
public interface IFormComponentPersistenceManager
{
    ...
    /**
     * Persist the a key/value pair applying the 'path' provided. The key
     * usually the FormComponent's page relative path and value the the
     * FormComponent' value. The path provided can be seen an additional means
     * create unique primary keys to store the data.
     * 
     * @param name
     *            The FormComponent's name
     * @param value
     ...
     * by default is the components page relative path (
     * 
