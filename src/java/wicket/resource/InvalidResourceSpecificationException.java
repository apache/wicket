/*
 * $Id: InvalidResourceSpecificationException.java,v 1.3 2005/01/02 21:58:23
...
/**
 * Exception thrown if a request is made to obtain a resource for which the
 * specified information is invalid. This is normally the case where the
 * information supplied to loader methods is incomplete.
 * 
 * @author Chris Turner
 */
public class InvalidResourceSpecificationException extends RuntimeException
{
    ...
    /**
     * Create the exception with the given message, wrapping the given cause.
     * 
     * @param message
     *            The message
     * @param cause
