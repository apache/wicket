 ...
 * <p>
 * The lastPathComponent(), firstPathComponent(), afterFirstPathComponent()
 * and beforeLastPathComponent() methods can chop up a String into path 
 * components using a separator character.  If the separator cannot be found
 * the original String is returned.
 * <p>
 * Similarly, the beforeLast(), beforeFirst(), afterFirst() and afterLast()
 * methods return sections before and after a separator character.  But if
 * the separator cannot be found, an empty string is returned.
 * <p>
 * Some other miscellaneous methods will strip a given ending off a String 
 * if it can be found (stripEnding()), replace all occurrences of one String
 * with another (replaceAll), do type conversions (toBoolean(), toChar(), 
 * toString()), check a String for emptiness (isEmpty()), convert a Throwable
 * to a String (toString(Throwable)) or capitalize a String (capitalize()).
 * 
...
public final class Strings
{
     ...
     * characters with HTML entities where appropriate.  Spaces are converted 
     * to non-breaking spaces (&lt;nbsp&gt;) if escapeSpaces is true, tabs are converted 
     * to four non-breaking spaces, less than signs are converted to &amp;lt; entities
     * and greater than signs to &amp;gt; entities.
     * @param s The string to escape
    ...
    /**
     * Converts a String to multiline HTML markup by replacing newlines with line
     * break entities (&lt;br&gt;) and multiple occurrences of newline with paragraph break
     * entities (&lt;p&gt;). 
     * @param s String to transform
     * @return String with all single occurrences of newline replaced with &lt;br&gt; 
     * and all multiple occurrences of newline replaced with &lt;p&gt;.
     */
    ...
    /**
     * Gets everything after the first path component of a path using a 
     * given separator.  If the separator cannot be found, an empty String
     * is returned.
     * <p>
    ...
    /**
     * Gets everything before the last path component of a path using a 
     * given separator.  If the separator cannot be found, the path itself
     * is returned.
     * <p>
     ...
     * @return Everything before the last occurrence of the given character in s. If
     ...
     * @param s The string
     * @param c The character
     * @return Everything before the first occurrence of the given character in s. If
     *         the character cannot be found, an empty string is returned.
     */
     ...
     * @param s The string
     * @param c The character
     * @return Everything after the first occurrence of the given character in s. If
     *         the character cannot be found, an empty string is returned.
     */
     ...
     * @param s The string
     * @param c The character
     * @return Everything after the last occurrence of the given character in s. If the
