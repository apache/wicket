...
/**
 * Interface to an application. An application has a name, settings and a
 ...
 * <p>
 * Currently there is only one kind of application, HttpApplication, which is a
 * servlet and therefore subclasses javax.servlet.http.HttpServlet.
 * HttpApplication's name and settings are available through its IApplication
 * interface.
 * 
