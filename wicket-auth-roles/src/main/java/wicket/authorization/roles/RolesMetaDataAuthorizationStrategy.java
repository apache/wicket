 ...
 * 
 * @see wicket.authorization.roles.RolesBinder
 * @see wicket.MetaDataKey
 * 
 * @author Eelco Hillenius
 */
public class RolesMetaDataAuthorizationStrategy extends AbstractRolesAuthorizationStrategy
{
	/**
	 * Construct.
	 * 
	 ...
	 */
	public RolesMetaDataAuthorizationStrategy(IRolesAuthorizer rolesAuthorizer)
	{
	...
	public boolean authorizeInstantiation(Class componentClass)
	{
		...
		String[] roles = RolesBinder.rolesForCreation(componentClass);
		return any(roles);
	}
	...
	public boolean authorizeAction(Component component, Action action)
	{
		...
		String[] roles = RolesBinder.rolesForAction(component, action);
		return any(roles);
	}
}
