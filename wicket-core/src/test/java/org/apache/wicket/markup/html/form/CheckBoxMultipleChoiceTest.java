...
public class CheckBoxMultipleChoiceTest extends WicketTestCase
{
	...
	public void defaultLabelPositionIsAfter() throws Exception
	{
		...
		tester.assertResultPage("<span wicket:id=\"testid\"><input name=\"testid\" type=\"checkbox\" value=\"0\" id=\"testid1-testid_0\"/><label for=\"testid1-testid_0\">1</label><br/>\n</span>");
	}
	...
	public void labelPositionBefore() throws Exception
	{
		...
		tester.assertResultPage("<span wicket:id=\"testid\"><label for=\"testid1-testid_0\">1</label><input name=\"testid\" type=\"checkbox\" value=\"0\" id=\"testid1-testid_0\"/><br/>\n</span>");
	}
	...
	public void labelPositionWrapBefore() throws Exception
	{
		...
		tester.assertResultPage("<span wicket:id=\"testid\"><label>1 <input name=\"testid\" type=\"checkbox\" value=\"0\" id=\"testid1-testid_0\"/></label><br/>\n</span>");
	}
	...
	public void labelPositionWrapAfter() throws Exception
	{
		...
		tester.assertResultPage("<span wicket:id=\"testid\"><label><input name=\"testid\" type=\"checkbox\" value=\"0\" id=\"testid1-testid_0\"/> 1</label><br/>\n</span>");
	}
}
