...
public class PackageResourceReferenceTest extends WicketTestCase
{
	...
	public void doNotFindNullResourceInTheCache()
	{
		...
		when(resourceStreamLocator.locate(scope, "org/apache/wicket/request/resource/z.css",
		...
		verify(resourceStreamLocator, times(2)).locate(PackageResourceReferenceTest.class,
			"org/apache/wicket/request/resource/z.css", "orange", null, null, null, false);
	}
	...
	{
		IResourceStreamLocator resourceStreamLocator = mock(IResourceStreamLocator.class);
		when(resourceStreamLocator.locate(scope, "org/apache/wicket/request/resource/a.css",
		...
		verify(resourceStreamLocator, times(2)).locate(PackageResourceReferenceTest.class,
			"org/apache/wicket/request/resource/a.css", "yellow", null, null, null, false);
	}
