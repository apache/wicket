...
public class LocaleResourceNameIterator implements Iterator<String>
{
	...
	{
		// Building the locale allocates and goes through the BaseLocale cache rather than being a
		// field read, and this is called once per candidate name; the state only changes in next().
