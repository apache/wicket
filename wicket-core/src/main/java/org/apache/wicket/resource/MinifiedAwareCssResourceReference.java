 ...
 */
public class MinifiedAwareCssResourceReference extends CssResourceReference
{
	private static final long serialVersionUID = 1L;

	private static final Logger log = LoggerFactory.getLogger(MinifiedAwareCssResourceReference.class);

	/* cache for existence check of minified file */
	private Boolean minifiedExists = null;

	/**
	 * Creates a new {@code MinifiedAwareCssResourceReference}
	 * 
	 * @param scope
	 *            mandatory parameter
	 * @param name
	 ...
	 *            resource variation
	 */
	public MinifiedAwareCssResourceReference(Class<?> scope, String name, Locale locale,
	 ...
	 *            mandatory parameter
	 */
	public MinifiedAwareCssResourceReference(Class<?> scope, String name)
	{
		super(scope, name);
	}
