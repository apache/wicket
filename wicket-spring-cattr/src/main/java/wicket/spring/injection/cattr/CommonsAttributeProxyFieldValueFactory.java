 ...
 *
 */
public class CommonsAttributeProxyFieldValueFactory implements IFieldValueFactory
{
	 ...
	 */
	public CommonsAttributeProxyFieldValueFactory(ISpringContextLocator contextLocator)
	{
	...
	public Object getFieldValue(Field field, Object fieldOwner)
	{
		...
		{
			SpringBean attribute = (SpringBean)Attributes.getAttribute(field, SpringBean.class);
			SpringBeanLocator locator = new SpringBeanLocator(attribute.getName(), field
